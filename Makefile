# This Makefile is for the TkSave extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/TkSave.pm]
#     AUTHOR => q[Robin Bank <robin@>]
#     NAME => q[TkSave]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/TkSave.pm]
...
TO_INST_PM = lib/TkSave.pm

PM_TO_BLIB = lib/TkSave.pm \
	blib/lib/TkSave.pm
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW)\
	  lib/TkSave.pm $(INST_MAN3DIR)/TkSave.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/TkSave.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         TkSave' >> META.yml
	$(NOECHO) $(ECHO) 'version:      undef' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: lib/TkSave.pm' >> META.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>Robin Bank &lt;robin@&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/TkSave.pm blib/lib/TkSave.pm 
	$(NOECHO) $(TOUCH) $@
